...
func Test_anyIntToBytes(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "test 1010000000000000 as 16", args: args{x: 0b1010000000000000, size: 16}, want: []byte{0b10100000, 0}},
		{name: "test 1010000000000000 as 17", args: args{x: 0b1010000000000000, size: 17}, want: []byte{0, 0b10100000, 0}},
	}
